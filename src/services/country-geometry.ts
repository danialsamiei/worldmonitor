...
const COUNTRY_GEOJSON_URL = 'https://maps.qadr.alefba.dev/countries.geojson';

/** Optional higher-resolution boundary overrides sourced from Natural Earth (served from R2 CDN). */
const COUNTRY_OVERRIDES_URL = 'https://maps.qadr.alefba.dev/country-boundary-overrides.geojson';
