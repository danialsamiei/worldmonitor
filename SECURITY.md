...
If you discover a security vulnerability in QADR110, please report it responsibly:

1. **GitHub Private Vulnerability Reporting**: Use [GitHub's private vulnerability reporting](https://github.com/danialsamiei/qadr110/security/advisories/new) to submit your report directly through the repository.

2. **Direct Contact**: Alternatively, reach out to the repository owner [@danialsamiei](https://github.com/danialsamiei) directly through GitHub.
...
QADR110 is a client-side intelligence dashboard that aggregates publicly available data. Here are the key security areas:
...
- QADR110 aggregates publicly available OSINT data
...
- Vulnerabilities in the QADR110 codebase
...
Thank you for helping keep QADR110 and its users safe! 🔒
